...
> 🌐 Live Resource Index: https://70asunflower.github.io/ai-learning-journey/
...
- **Resource Index**: `0-Index.md` mirrors all resources — keep it in sync. Its
  `_Last updated: YYYY-MM-DD_` footer is the source of the `generated` date in
  `index.html` — **always bump it when editing 0-Index.md** (CI enforces this).
...
- **Web index**: `index.html` is auto-generated by `scripts/generate_index.py` from this README's navigation — after adding a resource, re-run the script and commit the regenerated file
